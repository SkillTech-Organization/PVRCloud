...
!define PRODUCT_NAME "SWHInterface"
...
OutFile "SWHInterfaceSetup.exe"
InstallDir "$PROGRAMFILES\SWHInterface"
...
Section "Fõszakasz" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite on
  File "..\SWHInterface\bin\Release\*.dll"
 
SectionEnd

Section -AdditionalIcons
  CreateDirectory "$SMPROGRAMS\SWHInterface"
  CreateShortCut "$SMPROGRAMS\SWHInterface\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd
