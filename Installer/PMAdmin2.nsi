...
OutFile "PMAdminSetup.exe"
InstallDir "$PROGRAMFILES\PMAdmin"
...
Section "Fõszakasz" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite on
  File "..\PMAdmin\bin\Release\*.dll"
  File "..\PMAdmin\bin\Release\*.exe"
 
SectionEnd

Section -AdditionalIcons
  CreateDirectory "$SMPROGRAMS\PMAdmin"
  CreateShortCut "$SMPROGRAMS\PMAdmin\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd
